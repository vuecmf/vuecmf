...
module.exports = (api, options, rootOptions) => {
    ...
    api.extendPackage({
        ...
        keyword: "vuecmf-web vuecmf vue3 vuecmf开发框架",
        ...
        repository: {
            type: "git",
            url: "git+https://github.com/emei8/vuecmf-web.git"
        },
        dependencies: {
            "@types/node": "^16.11.12",
            "axios": "^0.24.0",
            ...
            "vue": "^3.2.0",
            "vue-router": "^4.0.0-0",
            "vue-vuecmf-dialog": "^1.4.1",
            "vue3-vuecmf-table": "^1.11.1",
            "vuex": "^4.0.0-0"
        },
        devDependencies: {
        ...
        bugs: {
            "url": "https://github.com/emei8/vuecmf-web/issues"
        },
        homepage: "https://github.com/emei8/vuecmf-web#readme"
    })
